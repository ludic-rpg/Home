...
It has been two years since my friends and fellow players suggested that I share more of what I create for our games and sessions. I spent a year thinking about how to do it, and now it is finally taking shape under the name **[Ludic RPG](/about/)**.
...
Last summer, I picked up a stock of seventeen RPG books from a closing shop. When I opened the box, I decided to begin with **Alien RPG, 1st Edition**. While reading, I was not fully satisfied with the campaign, but I was in awe of the system and the quality of the props included in each module. So I decided to completely rewrite the **[Heart of Darkness campaign](/blog/behind-the-scenes-of-my-first-alien-rpg-campaign/)**.

## Alien RPG

Alien RPG was an easy opportunity to bring technology to the table. So I started small. I built a **[motion tracker app](/blog/building-the-alien-rpg-motion-tracker-immersion-without-friction/)** for phones, then a **[map visualizer](/blog/experimenting-with-maps-limits-and-freedom-in-tabletop-worlds/)** to explore layouts and encounters.
