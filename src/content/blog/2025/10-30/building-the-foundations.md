...
I know the **[map editor](/blog/experimenting-with-maps-limits-and-freedom-in-tabletop-worlds/)** will be much more complex than the viewer. Rather than rushing to stack new features, I decided to invest time into making the system strong and sustainable. The current result is not very flashy, but it is rock solid, and that is exactly what is needed for what comes next.
